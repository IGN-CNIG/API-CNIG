...
<head>
    ...
    <link href="plugins/editiontools/editiontools.ol.min.css" rel="stylesheet" />
    <link href="plugins/styletools/styletools.ol.min.css" rel="stylesheet" />
    </link>
    <style type="text/css">
        html,
        body {
...
<body>
    ...
    <script type="text/javascript" src="plugins/editiontools/editiontools.ol.min.js"></script>
    <script type="text/javascript" src="plugins/styletools/styletools.ol.min.js"></script>
    <%
   ...
   %>
    <script type="text/javascript">
        ...
        const mp10 = new M.plugin.EditionTools(9);
        const mp11 = new M.plugin.StyleTools();
