...
<body>
    <div>
        ...
        <input type="text" id="selectURL" list="urlSug" value="https://mapea-lite-6.desarrollo.guadaltel.es/api-core//api-core/" />
        <datalist id="urlSug">
            <option value="https://mapea-lite-6.desarrollo.guadaltel.es/api-core//api-core/"></option>
   ...
   %>
    <script type="text/javascript">
        ...
        buttonApi.addEventListener('click', function() {
            ...
            window.location.href = 'https://mapea-lite-6.desarrollo.guadaltel.es/api-core//api-core/?sharemap=' + url + '*' + posicion;
        })
