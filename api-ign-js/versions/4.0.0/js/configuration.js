...
(function(M) {
   ...
   * @api stable
   */
  M.config('MAPEA_URL', 'https://mapea-lite-6.desarrollo.guadaltel.es/api-core/');
   ...
   * @api stable
   */
  M.config('PROXY_URL', location.protocol + '//mapea-lite-6.desarrollo.guadaltel.es/api-core/api/proxy');
   ...
   * @api stable
   */
  M.config('PROXY_POST_URL', location.protocol + '//mapea-lite-6.desarrollo.guadaltel.es/api-core/proxyPost');
   ...
   * @api stable
   */
  M.config('THEME_URL', location.protocol + '//mapea-lite-6.desarrollo.guadaltel.es/api-core/assets/');
   ...
   * @api stable
   */
  M.config('GEOPRINT_URL', 'https://geoprint.desarrollo.guadaltel.es');
   ...
   * @api stable
   */
  M.config('GEOREFIMAGE_TEMPLATE', 'https://geoprint.desarrollo.guadaltel.es' + '/print/mapexport');
   ...
   * @api stable
   */
  M.config('PRINTERMAP_TEMPLATE', 'https://geoprint.desarrollo.guadaltel.es' + '/print/CNIG');
   ...
   * @api stable
   */
  M.config('GEOPRINT_STATUS', 'https://geoprint.desarrollo.guadaltel.es' + '/print/status');
  ...
  M.config('attributions', {
    ...
    url: 'https://mapea-lite-6.desarrollo.guadaltel.es/api-core/files/attributions/WMTS_PNOA_20170220/atribucionPNOA_Url.kml',
    type: 'kml',
  });
   ...
   * @type {String}
   */
  M.config('SQL_WASM_URL', location.protocol + 'https://mapea-lite-6.desarrollo.guadaltel.es/api-core/wasm/');
