...
(function(M) {
   ...
   * @api stable
   */
  M.config('MAPEA_URL', 'https://mapea-lite.desarrollo.guadaltel.es/api-core');
   ...
   * @api stable
   */
  M.config('PROXY_URL', location.protocol + '//mapea-lite.desarrollo.guadaltel.es/api-core/api/proxy');
   ...
   * @api stable
   */
  M.config('PROXY_POST_URL', location.protocol + '//mapea-lite.desarrollo.guadaltel.es/api-core/proxyPost');
   ...
   * @api stable
   */
  M.config('THEME_URL', location.protocol + '//mapea-lite.desarrollo.guadaltel.es/api-core/assets/');
