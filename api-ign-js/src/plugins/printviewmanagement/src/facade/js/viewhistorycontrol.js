...
export default class ViewHistoryControl extends M.Control {
   ...
   */
  active(html) {
    const viewhistoryactive = html.querySelector('#m-printviewmanagement-viewhistory').classList.contains('activated');
    this.deactive(html);
    if (!viewhistoryactive) {
      html.querySelector('#m-printviewmanagement-viewhistory').classList.add('activated');
   ...
   */
  deactive(html) {
    html.querySelector('#m-printviewmanagement-viewhistory').classList.remove('activated');
