...
export default class ZoomExtentControl extends M.Control {
   ...
   */
  active(html) {
    const zoomextentactive = html.querySelector('#m-printviewmanagement-zoomextent').classList.contains('activated');
    if (!zoomextentactive) {
      html.querySelector('#m-printviewmanagement-zoomextent').classList.add('activated');
   ...
   */
  deactive() {
    document.querySelector('#m-printviewmanagement-zoomextent').classList.remove('activated');
