...
export default class ZoomPanelControl extends M.Control {
   ...
   */
  active(html) {
    const zoompanelactive = html.querySelector('#m-printviewmanagement-zoompanel').classList.contains('activated');
    this.deactive(html);
    if (!zoompanelactive) {
      html.querySelector('#m-printviewmanagement-zoompanel').classList.add('activated');
   ...
   */
  deactive(html) {
    html.querySelector('#m-printviewmanagement-zoompanel').classList.remove('activated');
