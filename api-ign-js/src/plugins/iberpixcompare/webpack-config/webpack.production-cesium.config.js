...
module.exports = {
  mode: 'production',
  entry: {
    'iberpixcompare.cesium.min': path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
    [`iberpixcompare-${pjson.version}.cesium.min`]: path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
  },
  output: {
