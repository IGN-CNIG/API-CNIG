...
module.exports = {
  mode: 'production',
  entry: {
    'topographicprofile.cesium.min': path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
    [`topographicprofile-${pjson.version}.cesium.min`]: path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
  },
  output: {
