...
module.exports = {
  mode: 'production',
  entry: {
    'predefinedzoom.cesium.min': path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
    [`predefinedzoom-${pjson.version}.cesium.min`]: path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
  },
  output: {
