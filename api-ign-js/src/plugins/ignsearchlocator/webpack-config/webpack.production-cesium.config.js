...
module.exports = {
  mode: 'production',
  entry: {
    'ignsearchlocator.cesium.min': path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
    [`ignsearchlocator-${pjson.version}.cesium.min`]: path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
  },
  output: {
