...
function fun(M_) {
   ...
   * @api stable
   */
  M_.config('MAPEA_URL', 'https://mapea-lite-6.desarrollo.guadaltel.es/api-ign/');
   ...
   * @api stable
   */
  M_.config('PROXY_URL', location.protocol + '//mapea-lite-6.desarrollo.guadaltel.es/api-ign/api/proxy');
   ...
   * @api stable
   */
  M_.config('PROXY_POST_URL', location.protocol + '//mapea-lite-6.desarrollo.guadaltel.es/api-ign/proxyPost');
   ...
   * @api stable
   */
  M_.config('THEME_URL', location.protocol + '//mapea-lite-6.desarrollo.guadaltel.es/api-ign/assets/');
